...
namespace SoftwareLocker
{
    ...
    public class TrialMaker
    {
        ...
        public TrialMaker(string SoftwareName,
            ...
            string Identifier, string Server, string IDcompany, string SpFile, string Proid, string type_license)
        {
        ...
        public RunTypes ShowDialog()
        {
            ...
            frmDialog PassDialog = new frmDialog(_BaseString, _Password, DaysToEnd(), _Runed, _Text, _Identifier, _Server, _IDcompany, _SpFile, _Proid, _type_license);
        ...
        public void MakeRegFileTemp()
        {
            string bb = Encryption.Boring(Encryption.InverseByBase(SystemInfo.GetSystemInfo("ThaiKidCanWriteTemp"), 10));

            FileReadWrite.WriteFile(_RegFilePath, Encryption.MakePassword(bb, _Identifier));
            //�M������~�u��
